...
class TestScoreboard(unittest.TestCase):
    ...
    def test_add_score(self):
        ...
        self.assertEqual(self.scoreboard.scores, {"Alice": {"scores": [10], "games_played": 1},
    ...
    def test_get_high_scores(self):
        ...
        self.assertEqual(high_scores, [("Charlie", 30, 1), ("Bob", 20, 1), ("Alice", 10, 1)])
    ...
    def test_load_scores(self):
        ...
        with open("scores.json", "w") as f:
            f.write('{"Alice": {"scores": [10, 20], "games_played": 2}, "Bob": {"scores": [30], "games_played": 1}}')
        self.scoreboard.load_scores()
        self.scoreboard.add_score("Alice", 30)
        self.assertEqual(self.scoreboard.scores, {"Alice": {"scores": [10, 20, 30], "games_played": 3},
    ...
    def test_save_scores(self):
        ...
        with open("scores.json", "r") as f:
            self.assertEqual(f.read(), '{"Alice": {"scores": [10], "games_played": 1}, "Bob": {"scores": [20], "games_played": 1}, "Charlie": {"scores": [30], "games_played": 1}}')
    ...
    def test_change_player_name(self):
        ...
        self.assertEqual(self.scoreboard.scores, {"Alice2": {"scores": [10], "games_played": 1}})
    ...
    def test_add_score_multiple_games(self):
        ...
        self.assertEqual(self.scoreboard.scores, {"Alice": {"scores": [10, 20], "games_played": 2},
    ...
    def test_get_player_stats(self):
        ...
        self.scoreboard.add_score("Bob", 30)
        self.scoreboard.add_score("Bob", 40)
        self.assertEqual(self.scoreboard.get_player_stats("Alice"), {"name": "Alice", "scores": [10, 20], "games_played": 2, "average_score": 15})
        self.assertEqual(self.scoreboard.get_player_stats("Bob"), {"name": "Bob", "scores": [30, 40], "games_played": 2, "average_score": 35})
        self.assertEqual(self.scoreboard.get_player_stats("Charlie"), {"name": "Charlie", "scores": [], "games_played": 0, "average_score": 0})
