...
class TestMain(unittest.TestCase):
    ...
    def test_start_with_choice_one(self, mock_input):
        main = Main()
    ...
    def test_show_rules(self):
        ...
        expected_output = ("+" + "-"*64 + "+\n" +
                           ...
                           "+" + "-"*64 + "+\n" +
                           "|" + " "*64 + "|\n" +
                           "|" + " "*7 + "The objective of the game is to be the first player" + " "*6 + "|\n" +
                           "|" + " "*7 + "to reach 100 points." + " "*37 + "|\n" +
                           "|" + " "*64 + "|\n" +
                           "|" + " "*7 + "On each turn, the player rolls a six-sided die. If" + " "*7 + "|\n" +
                           "|" + " "*7 + "the player rolls a 1, their turn ends and they" + " "*11 + "|\n" +
                           "|" + " "*7 + "receive no points." + " "*39 + "|\n" +
                           "|" + " "*64 + "|\n" +
                           "|" + " "*7 + "If the player rolls any other number, they can" + " "*11 + "|\n" +
                           "|" + " "*7 + "choose to roll again or hold to keep score." + " "*14 + "|\n" +
                           "|" + " "*64 + "|\n" +
                           "|" + " "*7 + "If a player chooses to hold their turn, " + " "*17 + "|\n" +
                           "|" + " "*7 + "total is added to their score." + " "*27 + "|\n" +
                           "|" + " "*64 + "|\n" +
                           "+" + "-"*64 + "+\n")
        with patch('sys.stdout', new=StringIO()) as fake_out:
            main.show_rules()
