...
class Main:
    ...
    def show_rules(self):
        ...
        print("+" + "-"*64 + "+")
        print("|" + " "*64 + "|")
        print("|" + " "*7 + "The objective of the game is to be the first player" + " "*6 + "|")
        print("|" + " "*7 + "to reach 100 points." + " "*37 + "|")
        print("|" + " "*64 + "|")
        print("|" + " "*7 + "On each turn, the player rolls a six-sided die. If" + " "*7 + "|")
        print("|" + " "*7 + "the player rolls a 1, their turn ends and they" + " "*11 + "|")
        print("|" + " "*7 + "receive no points." + " "*39 + "|")
        print("|" + " "*64 + "|")
        print("|" + " "*7 + "If the player rolls any other number, they can" + " "*11 + "|")
        print("|" + " "*7 + "choose to roll again or hold to keep score." + " "*14 + "|")
        print("|" + " "*64 + "|")
        print("|" + " "*7 + "If a player chooses to hold their turn, " + " "*17 + "|")
